...
# $3 num of ap
gen_spec(){
	$HOMFA ltl2spec "$1" $3 | $HOMFA --quiet spec2spec --minimized > $2
}
...
# $3 num of ap
gen_reversed_spec(){
	$HOMFA ltl2spec "$1" $3 | $HOMFA --quiet spec2spec --reversed |$HOMFA --quiet spec2spec --minimized > $2
}
...
TOWARDS_005='!F[200,600]G[0,150]((p8)|(p4&p5&p6&p7))'
TOWARDS_006='!F[200,600]G[0,150]((!p6&!p7&!p8)|(!p2&!p3&!p4&!p5&!p7&!p8)|(!p1&!p3&!p4&!p5&!p7&!p8)|(!p0&!p3&!p4&!p5&!p7&!p8))'
...
#gen_spec "$TOWARDS_005" towards-005.spec 9
#gen_spec "$TOWARDS_006" towards-006.spec 9
...
#gen_reversed_spec "$TOWARDS_005" towards-005-rev.spec 9
#gen_reversed_spec "$TOWARDS_006" towards-006-rev.spec 9
